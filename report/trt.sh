...
treatment () {
    ...
    #   separator: blank
    ./generate.py --num $1 | LC_ALL=C sort +1n -2 +2n -3 +3n -4 +4n -5 | ./rupture.py --file -
}
...
empty () {
    echo -n "" | ./rupture.py --file -
}

# test of a file badly sorted for key1 - reversed order
testkey1 () {
    ./generate.py --num $1 | LC_ALL=C sort +1rn -2 +2n -3 +3n -4 +4n -5 | ./rupture.py --file -
}

# test of a file badly sorted for key2 - reversed order
testkey2 () {
    ./generate.py --num $1 | LC_ALL=C sort +1n -2 +2rn -3 +3n -4 +4n -5 | ./rupture.py --file -
}

# test of a file badly sorted for key3 - reversed order
testkey3 () {
    ./generate.py --num $1 | LC_ALL=C sort +1n -2 +2n -3 +3rn -4 +4n -5 | ./rupture.py --file -
}
